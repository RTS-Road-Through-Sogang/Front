    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/selectecodutychoice" element={<SelectEcoDutyChoice />} />
          <Route path="/selectcsedutychoice" element={<SelectCseDutyChoice />} />
           <Route path="/selectmgtdutychoice" element={<SelectmgtDutyChoice />} />
          ...
          <Route path="/selectsubecoduty" element={<SelectSubEcoDuty />} />
           ...
           <Route path="/selectsubcsedutychoice" element={<SelectSubCseDutyChoice />} />
          <Route path="/selectsubmgtdutychoice" element={<SelectSubmgtDutyChoice />} />
          <Route path="/selectsubecodutychoice" element={<SelectSubEcoDutyChoice />} />
